  ...
  return (
    <div className="max-w-lg space-y-6">
      ...
      <form onSubmit={handleSubmit} className="card p-6 space-y-4">
        ...
        {/* IBAN y NIF: solo lectura, no los puede cambiar el empleado */}
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="label">IBAN <span className="text-gray-400 font-normal">(solo lectura)</span></label>
            <input type="text" className="input opacity-60 cursor-not-allowed" value={form.iban} readOnly />
          </div>
          <div>
            <label className="label">NIF <span className="text-gray-400 font-normal">(solo lectura)</span></label>
            <input type="text" className="input opacity-60 cursor-not-allowed" value={form.nif} readOnly />
          </div>
        </div>
